...
<!--  BEGIN TOPBAR  -->
 ...
 <div id="content" class="main-content my-4" >
            <div class="layout-px-spacing">
                <h2 class="text-center">ESCUELA DE FUTSAL</h2>
                ...
                <div class="row layout-top-spacing">
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        ...
                        <div class="mail-box-container" >
                           ...
                           <img alt="logo" src="<?php echo base_url(); ?>assets/img/logo1.jpg" width=400>
                            <div class="tab-title">

                                    <div class="col-md-12 col-sm-12 col-12 text-center">
                                    <img alt="logo" src="<?php echo base_url(); ?>assets/img/ligaNacional.jpg" width=900>
                                </div>
                                 <h5 class="text-center">Escuela de futsal VICTOR MURIEL creada para niños , niñas , jovenes , señoritas y persona mayores.</h5>
            </div>
